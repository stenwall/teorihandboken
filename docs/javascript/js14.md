...
#### Skapa en klass `Rectangle` med variablerna `width ` och `height`
{:.no_toc}
...
#### Skapa en area-funktion som räknar ut ytan på rektangeln
{:.no_toc}
...
```
#### Skapa en variabel som innehåller ett rektangel-objekt och logga arean
{:.no_toc}
